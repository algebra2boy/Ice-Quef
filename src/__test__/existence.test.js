...
describe('log in page', () => {
  it('determines logo is in the log in page', async () => {
    const screen = render(<LoginPageDefault />);
...
describe('manage', () => {
  it('determines elements in default manage page', async () => {
    const screen = render(<ManagePageDefault officeHour={[]} setOfficeHour={() => {}} />);
...
describe('profile', () => {
  it('determines profile page exists', async () => {
    const screen = render(<ProfilePageDefault />);
