...
var _HourGuideCell = function (_a) {
    ...
    return (React__namespace.createElement(reactNative.TouchableWithoutFeedback, { onLongPress: function () { return onLongPress(date.hour(hour).minute(0)); }, onPress: function () { return onPress(date.hour(hour).minute(0)); } },
...
function _CalendarBody(_a) {
    ...
    return (React__namespace.createElement(React__namespace.Fragment, null,
        ...
        React__namespace.createElement(reactNative.ScrollView, __assign({ style: [
                ...
                style,
            ], ref: scrollView, scrollEventThrottle: 32 }, (reactNative.Platform.OS !== 'web' ? panResponder.panHandlers : {}), { showsVerticalScrollIndicator: showVerticalScrollIndicator, nestedScrollEnabled: true, contentOffset: reactNative.Platform.OS === 'ios' ? { x: 0, y: scrollOffsetMinutes } : { x: 0, y: 0 } }),
            React__namespace.createElement(reactNative.View, __assign({ style: [u['flex-1'], theme.isRTL ? u['flex-row-reverse'] : u['flex-row']] }, (reactNative.Platform.OS === 'web' ? panResponder.panHandlers : {})),
                (!hideHours || showWeekNumber) && (React__namespace.createElement(reactNative.View, { style: [u['z-20'], u['w-50']] }, hours.map(function (hour) { return (React__namespace.createElement(HourGuideColumn, { key: hour, cellHeight: cellHeight, hour: hour, ampm: ampm, hourStyle: hourStyle })); }))),
                dateRange.map(function (date) { return (React__namespace.createElement(reactNative.View, { style: [u['flex-1'], u['overflow-hidden']], key: date.toString() },
                    hours.map(function (hour, index) { return (React__namespace.createElement(HourGuideCell, { key: hour, cellHeight: cellHeight, date: date, hour: hour, onLongPress: _onLongPressCell, onPress: _onPressCell, index: index, calendarCellStyle: calendarCellStyle })); }),
                    _renderEvents(date),
...
function _CalendarEventForMonthView(_a) {
    ...
    return (React__namespace.createElement(reactNative.TouchableOpacity, { style: { minHeight: eventMinHeightForMonthView }, onPress: function () { return !event.disabled && (onPressEvent === null || onPressEvent === void 0 ? void 0 : onPressEvent(event)); } }, (!isMultipleDays && date.isSame(event.start, 'day')) ||
...
function _CalendarBodyForMonthView(_a) {
    ...
    var now = useNow(!hideNowIndicator).now;
    var _c = React__namespace.useState(0), calendarWidth = _c[0], setCalendarWidth = _c[1];
    var _d = React__namespace.useState(0), calendarCellHeight = _d[0], setCalendarCellHeight = _d[1];
    var panResponder = usePanResponder({
        onSwipeHorizontal: onSwipeHorizontal,
    });
    ...
    return (React__namespace.createElement(reactNative.View, __assign({ style: [
        ...
        showWeekNumber ? (React__namespace.createElement(reactNative.View, { style: [
                i > 0 && u['border-t'],
                { borderColor: theme.palette.gray['200'] },
                u['p-2'],
                u['w-20'],
        ...
        week
            ...
            .map(function (date, ii) { return (React__namespace.createElement(reactNative.TouchableOpacity, { onLongPress: function () { return date && onLongPressCell && onLongPressCell(date.toDate()); }, onPress: function () { return date && onPressCell && onPressCell(date.toDate()); }, style: [
                i > 0 && u['border-t'],
            ...
            React__namespace.createElement(TouchableGradually, { style: {
...
function _CalendarHeader(_a) {
    var dateRange = _a.dateRange, cellHeight = _a.cellHeight, style = _a.style, allDayEvents = _a.allDayEvents, onPressDateHeader = _a.onPressDateHeader, onPressEvent = _a.onPressEvent, activeDate = _a.activeDate, _b = _a.headerContentStyle, headerContentStyle = _b === void 0 ? {} : _b, _c = _a.dayHeaderStyle, dayHeaderStyle = _c === void 0 ? {} : _c, _d = _a.dayHeaderHighlightColor, dayHeaderHighlightColor = _d === void 0 ? '' : _d, _e = _a.weekDayHeaderHighlightColor, weekDayHeaderHighlightColor = _e === void 0 ? '' : _e, _f = _a.showAllDayEventCell, showAllDayEventCell = _f === void 0 ? true : _f, _g = _a.hideHours, hideHours = _g === void 0 ? false : _g, _h = _a.showWeekNumber, showWeekNumber = _h === void 0 ? false : _h, _j = _a.weekNumberPrefix, weekNumberPrefix = _j === void 0 ? '' : _j;
    ...
    return (React__namespace.createElement(reactNative.View, { style: [
        ...
        (!hideHours || showWeekNumber) && (React__namespace.createElement(reactNative.View, { style: [u['z-10'], u['w-50'], u['pt-2'], borderColor] }, showWeekNumber ? (React__namespace.createElement(reactNative.View, { style: [
                { height: cellHeight },
...
function _CalendarHeaderForMonthView(_a) {
    ...
    return (React__namespace.createElement(reactNative.View, { style: [
        ...
        showWeekNumber ? (React__namespace.createElement(reactNative.View, { style: [u['w-20'], { paddingTop: 2 }], key: 'weekNumber' },
...
function _Schedule(_a) {
    ...
    var renderFlatListItem = function (eventGroup) {
        var date = dayjs__default["default"](eventGroup[0].start);
        var shouldHighlight = activeDate ? date.isSame(activeDate, 'date') : isToday(date);
        return (React__default["default"].createElement(reactNative.View, { style: [u['flex'], { padding: 2 }] },
...
function _CalendarContainer(_a) {
    ...
    var _11 = React__default["default"].useState(function () { return dayjs__default["default"](date); }), targetDate = _11[0], setTargetDate = _11[1];
    React__default["default"].useEffect(function () {
        if (dateString) {
    ...
    return (React__default["default"].createElement(React__default["default"].Fragment, null,
        ...
        React__default["default"].createElement(CalendarBody, __assign({}, commonProps, { style: bodyContainerStyle, containerHeight: height, events: daytimeEvents, eventCellStyle: eventCellStyle, calendarCellStyle: calendarCellStyle, hideNowIndicator: hideNowIndicator, overlapOffset: overlapOffset, scrollOffsetMinutes: scrollOffsetMinutes, ampm: ampm, showTime: showTime, onLongPressCell: onLongPressCell, onPressCell: onPressCell, onPressEvent: onPressEvent, onSwipeHorizontal: onSwipeHorizontal, renderEvent: renderEvent, headerComponent: headerComponent, headerComponentStyle: headerComponentStyle, hourStyle: hourStyle, isEventOrderingEnabled: isEventOrderingEnabled, showVerticalScrollIndicator: showVerticalScrollIndicator, enrichedEventsByDate: enrichedEventsByDate, enableEnrichedEvents: enableEnrichedEvents, eventsAreSorted: eventsAreSorted }))));
}
